...
## Context analysis
:::note
Context analysis has been superseded by [confidence levels](/#confidence-levels). Customers who had context analysis turned on will be migrated to confidence levels where applicable.
:::
